...
static int normalize_carrier(const char*value,char*out,size_t outsz) {
    ...
    if (!strcasecmp(value,"mobile")||!strcasecmp(value,"cmcc")||!strcasecmp(value,"china-mobile")||!strcmp(value,"移动")||!strcmp(value,"中国移动")) {
        snprintf(out,outsz,"mobile");
        return 0;
    }
    if (!strcasecmp(value,"telecom")||!strcasecmp(value,"ct")||!strcasecmp(value,"chinanet")||!strcasecmp(value,"china-telecom")||!strcmp(value,"电信")||!strcmp(value,"中国电信")) {
        snprintf(out,outsz,"telecom");
        return 0;
    }
    if (!strcasecmp(value,"unicom")||!strcasecmp(value,"cu")||!strcasecmp(value,"cuc")||!strcasecmp(value,"china-unicom")||!strcmp(value,"联通")||!strcmp(value,"中国联通")) {
...
static int carrier_from_asn(const char*asn,const char*as_name,char*out,size_t outsz) {
    if (!asn||!out)return-1;
    if (!strcmp(asn,"9808")||!strcmp(asn,"56040")||!strcmp(asn,"56041")||!strcmp(asn,"56042")||!strcmp(asn,"56044")||!strcmp(asn,"56046")||!strcmp(asn,"56047")||!strcmp(asn,"56048")||!strcmp(asn,"56050")||!strcmp(asn,"56052")||!strcmp(asn,"56055")||!strcmp(asn,"56056")||!strcmp(asn,"56057")||!strcmp(asn,"56058")||!strcmp(asn,"56059")||!strcmp(asn,"56060")||!strcmp(asn,"56061")||!strcmp(asn,"56062")) {
        snprintf(out,outsz,"mobile");
        return 0;
    }
    if (!strcmp(asn,"4134")||!strcmp(asn,"4809")||!strcmp(asn,"4812")||!strcmp(asn,"4816")||!strcmp(asn,"4811")||!strcmp(asn,"4813")||!strcmp(asn,"4815")||!strcmp(asn,"23724")||!strcmp(asn,"134756")) {
        snprintf(out,outsz,"telecom");
        return 0;
    }
    if (!strcmp(asn,"4837")||!strcmp(asn,"4808")||!strcmp(asn,"9929")||!strcmp(asn,"10099")||!strcmp(asn,"17621")||!strcmp(asn,"136958")||!strcmp(asn,"140717")) {
        snprintf(out,outsz,"unicom");
        return 0;
    }
    char upper[256]={0};
...
static int build_baidu_pool_for_carrier(BaiduProxyPool*pool,const char*carrier,CarrierResolverSpec*resolver_specs,size_t resolver_len) {
    ...
    for (size_t i=0;i<ips.len;i++) {
        char asn[64]={0},as_name[256]={0},mapped[MAX_NAME_LEN]={0};
...
static ResultList scan_ips(StringList*ips,Config*cfg,BaiduProxyPool*proxy_pool) {
    ...
    ScanCtx ctx= {
        .ips=ips->items,.total=ips->len,.results=&rl,.cfg=cfg,.proxy_pool=proxy_pool
    }
    ;
...
static void* carrier_accept_thread(void*arg) {
    ...
    while (atomic_load(&g_running)) {
        ...
        int cfd=accept(rt->listen_fd,(struct sockaddr*)&ss,&slen);
        if (cfd<0) {
...
int main(int argc,char**argv) {
    ...
    if (carrier_spec_len>0) {
        ...
        for (size_t i=0;i<carrier_spec_len;i++) {
            ...
            log_msg("%s 正在监听 %s，TLS目标端口：%d，非TLS目标端口：%d，连接尝试次数：%d，有效延迟：%d ms，策略：%s，日志：%s",carrier_display_name(rt->spec.carrier),rt->spec.addr,g_cfg.port,g_cfg.http_port,g_cfg.num,g_cfg.delay_ms,g_cfg.select_name,g_cfg.log_name);
