// 腾讯 Edge One Pages 版本 - 完全兼容格式
// 更新日期: 2025-09-08
// 基于原始 Cloudflare Worker 代码适配
...
<body class="light-mode">
  ...
  <div class="container mx-auto">
    <h1 class="text-3xl font-bold text-center mb-8">腾讯 Edge One 加速下载</h1>
    ...
    <footer class="mt-6 text-center text-gray-500 dark:text-gray-400">
      Powered by <a href="https://github.com/fscarmen2/Cloudflare-Accel" class="text-blue-500 hover:underline">fscarmen2/Cloudflare-Accel</a> | 腾讯 Edge One 版本
    </footer>
  </div>
